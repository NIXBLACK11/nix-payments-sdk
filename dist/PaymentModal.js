...
const PaymentModalComponent = ({ sessionId, RPC_URL, onRedirect }) => {
    const { publicKey, signTransaction } = (0, wallet_adapter_react_2.useWallet)();
